...
class PowerMonitorChannel(private val context: Context) : MethodChannel.MethodCallHandler {
    ...
    override fun onMethodCall(call: MethodCall, result: MethodChannel.Result) {
        when (call.method) {
            ...
            "getTodayLogEntries" -> handleGetTodayLogEntries(result)
    ...
    private fun handleGetTodayLogEntries(result: MethodChannel.Result) {
        try {
            val entries = backgroundLogger.getTodayLogEntries()
