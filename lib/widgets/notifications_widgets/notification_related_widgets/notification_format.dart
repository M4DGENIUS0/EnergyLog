...
class NotificationFormatSettings extends StatefulWidget {
  ...
  const NotificationFormatSettings({super.key, this.showBackButton = true});

  @override
  State<StatefulWidget> createState() => NotificationFormatSettingsState();
}

class NotificationFormatSettingsState
    extends State<NotificationFormatSettings> {
  Locale? locale;
  LocaleProvider? provider;
  List<String> selectedNotifications = [];
  List<String> notificationList = [];
  String? _selectedLanguage;
  DefaultSelectedNotificationsFormatsHook selectedNotification =
      HooksConfigurations.defaultSelectedNotificationsFormatsHook;
  AvailableNotificationsFormatsHook allNotificationList =
      HooksConfigurations.availableNotificationsFormatsHook;

  @override
  void initState() {
    final preSelectedHook =
        HooksConfigurations.defaultSelectedNotificationsFormatsHook;
    ...
    if (savedFormats != null && savedFormats.isNotEmpty) {
      selectedNotifications = savedFormats;
    } else {
  ...
  _showToast(BuildContext context, String msg) {
    ShowToastWidget(
      ...
      text: UtilityMethods.getLocalizedString(msg),
    );
  }
}
