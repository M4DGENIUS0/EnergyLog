...
class AppThemePreferences{
  ...
  ///
  /// These will be used for TextStyle.
  static double mockupCategoryTitleFontSize = 20.0;
  static double sliverAppBarTitleFontSize = 27.0;
  ...
  ///
  /// This will use now
  static double sliverAppBarTitleTextHeight = 1.2;
  ///
  ///
  ...
  /// This will going to use
  ///
  ///
  static FontWeight mockupCategoryTitleTextFontWeight = FontWeight.w700;
  static FontWeight sliverAppBarTitleFontWeight = FontWeight.bold;
  ...
  ///
  /// Warning Color:
  static Color? warningColor = Colors.amber[700];
  ///
  ...
  ///
  ///
  /// We are using these now
  static Color? mockupCategoryTitleColorLight = Colors.grey[900];
  static Color sliverAppBarTitleColorLight = Colors.black87;
  ///
  /// Canvas Size Container color
  static Color? canvasSizeContainerColorLight = Colors.black;
  ///
  /// Bottom Navigation Bar color
  static Color? bottomNavBarColorLight = Colors.black;
  ///
  /// Bottom Nav Bar Selected Item Text Color
  static Color? bottomNavBarSelectedItemColorLight = Colors.white;
  ///
  ...
  ////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
  //// These will going to use Now
  ///
  /// Layers Icon Color Light
  static Color layersIconColorLight = appSecondaryColor;
  ///
  /// Redo Changes Icon Color Light
  static Color redoChangesIconColorLight = appSecondaryColor;
  ///
  /// Undo Changes Icon Color Light
  static Color undoChangesIconColorLight = appSecondaryColor;
  ///
  /// Close Icon Color Light
  static Color closeIconColorLight = appSecondaryColor;
  ///
  /// Save Project Icon Color Light
  static Color saveProjectIconColorLight = appSecondaryColor;
  ///
  /// Download File Icon Color Light
  static Color downloadFileIconColorLight = appSecondaryColor;
  ///
  /// Dark Mode Colors:
  ///
  ///
  ...
  static Color? mockupCategoryTitleColorDark = Colors.grey[400];
  static Color? sliverAppBarTitleColorDark = Colors.grey[400];
  ///
  /// Canvas Size Container color
  static Color? canvasSizeContainerColorDark = Colors.white;
  ///
  /// Bottom Navigation Bar color
  ...
  ///
  /// Colors for Trending Up Card
  static Color trendingUpCardColor = const Color(0xFFddf1f0);
  /// Colors for Trending Down Card
  static Color trendingDownCardColor = const Color(0xFFfde7e9);
  /////////////////////////////////////////////////////////////////
  ///
  /// Layer Icon Dark
  static Color layersIconColorDark = appIconsMasterColorDark;
  ///
  /// Redo Changes Icon Dark
  static Color redoChangesIconColorDark = appIconsMasterColorDark;
  ///
  /// Undo Changes Icon Dark
  static Color undoChangesIconColorDark = appIconsMasterColorDark;
  ///
  /// Close Icon Dark
  static Color closeIconColorDark = appIconsMasterColorDark;
  ///
  /// Save Project Icon Dark
  static Color saveProjectIconColorDark = appIconsMasterColorDark;
  ///
  /// Download File Icon Dark
  static Color downloadFileIconColorDark = appIconsMasterColorDark;
  ...
  ///
  /// Canvas width for the mockup editor.
  final double defaultCanvasWidth   = 400.0;
  ///
  /// layers Icon Size
  static double layersIconSize = 24.0;
  ///
  /// Redo Changes Icon Size
  static double redoChangesIconSize = 24.0;
  ///
  /// Undo Changes Icon Size
  static double undoChangesIconSize = 24.0;
  ///
  /// Close Icon Size
  static double closeIconSize = 24.0;
  ///
  /// Project Save Icon Size
  static double saveProjectIconSize = 24.0;
  ///
  /// Download File Icon
  static double downloadFileIconSize = 24.0;
  ///
  /// Warning Icon Size
  ...
  ///
  /// Home Grid Icon
  static IconData homeGridIcon = Icons.grid_view_rounded;
  ///
  /// Create Mockup Icon
  static IconData createMockupIcon = Icons.add_box_rounded;
  ///
  /// Properties Icon
  ...
  ///
  /// Review Icon Outlined Icon
  static IconData reviewOutlined = Icons.rate_review_outlined;
  ///
  /// Reply Outlined Icon
  ...
  ///////////////////////////////////////////////////////////////////////////////////////////
  /// These are new one [Icons]
  ///
  ///
  /// New Font Icon
  static IconData fontIcon = Icons.font_download_outlined;
  ///
  /// Mobile Frames Icon
  static IconData mobileFramesIcon = Icons.smartphone_outlined;
  ///
  /// Pre made Templates Icon
  static IconData preMadeTemplatesIcon = Icons.dashboard_customize;
  ///
  /// Color for background Icon
  static IconData colorIcon = Icons.color_lens_outlined;
  ///
  /// Gradient Color Icon
  static IconData gradientColorIcon = Icons.gradient_outlined;
  ///
  /// Icon for background
  static IconData backgroundIcon = Icons.image_outlined;
  ///
  /// Icon for Elements
  static IconData elementsIcon = Icons.add_circle_outline_outlined;
  ///
  /// Icon for text
  static IconData textElementsIcon = Icons.text_fields_outlined;
  ///
  /// Icon for water mark
  static IconData waterMarkElementsIcon = Icons.water_drop_outlined;

  ///
  /// format Icon
  static IconData formatIcon = Icons.format_shapes_outlined;
  /// New Format Size Icon
  static IconData formatSizeIcon = Icons.format_size_outlined;
  ///
  /// New Format Color Icon
  static IconData formatColorIcon = Icons.format_color_text_outlined;
  ///
  /// New Format Stroke Icon
  static IconData formatStrokeIcon = Icons.format_strikethrough_outlined;
  ///
  /// New Format Shadow Icon
  static IconData formatShadowIcon = Icons.layers;
  ///
  /// New Format Arc Icon
  static IconData formatArcIcon = Icons.architecture;
  ///
  /// New Format LineSpace Icon
  static IconData formatLineSpaceIcon = Icons.format_line_spacing;
  ///
  /// New Format Word Space Icond
  static IconData formatWordSpaceIcon = Icons.space_bar;
  ///
  /// New Format Align Icon
  static IconData formatAlignTextIcon = Icons.format_align_left;
  ///
  /// New Format Flip Icon
  static IconData formatFlipTextIcon = Icons.flip_outlined;
  ///
  /// New Format Duplicate Icon
  static IconData formatDuplicateIcon = Icons.content_copy;
  ///
  /// format underline Icon
  static IconData formatUnderlineIcon = Icons.format_underline_outlined;
  ///
  /// Format Bold Icon
  static IconData formatBoldIcon = Icons.format_bold_outlined;
  ///
  /// Format Italic Icon
  static IconData formatItalicIcon = Icons.format_italic_outlined;
  ///
  /// Save Icon
  // static IconData saveIcon = Icons.save_rounded;
  ///
  /// Brush Icon
  static IconData brushIcon = Icons.brush_outlined;
  ///
  /// Text Icon
  static IconData textIcon = Icons.text_fields_outlined;
  ///
  /// Layer Icon
  static IconData layerIcon = Icons.layers_outlined;
  ///
  /// Undo Changes Icon
  static IconData undoChangesIcon = Icons.undo_outlined;
  ///
  /// Redo Changes Icon
  static IconData redoChangesIcon = Icons.redo_outlined;
  ///
  /// Download File Icon
  static IconData downloadFileIcon = Icons.file_download_outlined;
  ///
  /// Save Project Icon
  static IconData saveProjectIcon = Icons.save_outlined;
  ///
  /// Warning Icon
  static IconData warningIcon = Icons.warning_amber_outlined;
  ///
  ///
  ///
  /// Images:
...
class AppTheme{
  ...
  AppTheme({this.isDark = false}) {
    ...
    /// These will going to use for TextStyle.
    _mockupCategoryTitleTextStyle = TextStyle(fontSize: AppThemePreferences.mockupCategoryTitleFontSize, fontWeight: AppThemePreferences.mockupCategoryTitleTextFontWeight, color: isDark ? AppThemePreferences.mockupCategoryTitleColorDark : AppThemePreferences.mockupCategoryTitleColorLight);
    _sliverAppBarTitleTextStyle = TextStyle(
      fontSize: AppThemePreferences.sliverAppBarTitleFontSize,
      fontWeight: AppThemePreferences.sliverAppBarTitleFontWeight,
      height: AppThemePreferences.sliverAppBarTitleTextHeight,
      color: isDark
          ? AppThemePreferences.sliverAppBarTitleColorDark
          : AppThemePreferences.sliverAppBarTitleColorLight,
    );
    /// Brightness:
    ...
    _layersIcon = Icon(AppThemePreferences.layerIcon, size: AppThemePreferences.layersIconSize, color: isDark ? AppThemePreferences.layersIconColorDark : AppThemePreferences.layersIconColorLight);
    _redoIcon = Icon(AppThemePreferences.redoChangesIcon, size: AppThemePreferences.redoChangesIconSize, color: isDark ? AppThemePreferences.redoChangesIconColorDark : AppThemePreferences.redoChangesIconColorLight);
    _undoIcon = Icon(AppThemePreferences.undoChangesIcon, size: AppThemePreferences.undoChangesIconSize, color: isDark ? AppThemePreferences.undoChangesIconColorDark : AppThemePreferences.undoChangesIconColorLight);
    ...
    _saveProjectIcon = Icon(AppThemePreferences.saveProjectIcon, size: AppThemePreferences.saveProjectIconSize, color: isDark ? AppThemePreferences.saveProjectIconColorDark : AppThemePreferences.saveProjectIconColorLight);
    _downloadFileIcon = Icon(AppThemePreferences.downloadFileIcon, size: AppThemePreferences.downloadFileIconSize, color: isDark ? AppThemePreferences.downloadFileIconColorDark : AppThemePreferences.downloadFileIconColorLight);
    _warningIcon = Icon(AppThemePreferences.warningIcon, size: AppThemePreferences.warningIconSize, color: AppThemePreferences.warningColor);
    ///
    /// images:
  ...
  /// TextStyles:
  ///
  /// These will be removed  [These will be removed]
  ...
  ////////////////////////////////////////////////////////////////////////
  ///
  /// We are using these textStyle
  ///
  /// Mockup category TextStyles for the App.
  TextStyle? _mockupCategoryTitleTextStyle;
  TextStyle? get mockupCategoryTitleTextStyle => _mockupCategoryTitleTextStyle;
  ///
  /// Sliver AppBar Title TextStyle.
  TextStyle? _sliverAppBarTitleTextStyle;
  TextStyle? get sliverAppBarTitleTextStyle => _sliverAppBarTitleTextStyle;
  ///
  ///
  /// Brightness:
  ///
  ...
  //////////////////////////////////////////////////////////////////////////
  /// These going to use Now
  ///
  /// Canvas Size Container Color.
  Color? _canvasSizeContainerColor;
  Color? get canvasSizeContainerColor => _canvasSizeContainerColor;
  ///
  /// Bottom Navigation Bar Color.
  Color? _bottomNavigationBarBackgroundColor;
  Color? get bottomNavigationBarBackgroundColor => _bottomNavigationBarBackgroundColor;
  ///
  ...
  /////////////////////////////////////////////////////////
  ///
  ///  This will going to used now for [Icon]
  ///
  /// Save Project Icon
  Icon? _saveProjectIcon;
  Icon? get saveProjectIcon => _saveProjectIcon;
  ///
  /// Close Icon
  Icon? _closeIcon;
  ...
  /// Undo Icon
  Icon? _undoIcon;
  Icon? get undoIcon => _undoIcon;
  ///
  /// Redo Icon
  Icon? _redoIcon;
  Icon? get redoIcon => _redoIcon;
  ///
  /// Layers Icon
  Icon? _layersIcon;
  Icon? get layersIcon => _layersIcon;
  ///
  /// Download File Icon
  Icon? _downloadFileIcon;
  Icon? get downloadFileIcon => _downloadFileIcon;
  ///
  /// Warning Icon
  Icon? _warningIcon;
  Icon? get warningIcon => _warningIcon;
