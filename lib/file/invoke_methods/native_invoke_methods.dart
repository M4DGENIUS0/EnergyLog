...
class PowerMonitorService {
  ...
  static Future<bool> startLogging() async {
    try {
      final bool result = await _channel.invokeMethod('startLogging');
      return result;
    } on PlatformException catch (e) {
  ...
  static Future<bool> stopLogging() async {
    try {
      final bool result = await _channel.invokeMethod('stopLogging');
      return result;
    } on PlatformException catch (e) {
