...
String DEMO_URL = "https://google.com/";
...
// Color APP_LIGHT_COLOR = Color(0xFFE8EBEA);
Color APP_LIGHT_COLOR = Color(0xFFd9d9d9);
...
const String BATTERY_KEY = 'battery';
const String LEVEL_KEY = 'level';
const String USAGE_TIME_KEY = "usageTime";
...
const String APP_INFO_APP_PACKAGE_NAME = 'packageName';
