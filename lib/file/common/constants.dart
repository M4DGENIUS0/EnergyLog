...
// Color APP_SECONDARY_COLORS = Color(0xFF22332A);
...
const String HOUZI_VERSION = "1.0.1";
...
const String COUNTRIES_METADATA = 'CityMetaDataList';
...
const String locationWithTermPickerKey = "location_with_term_picker";
...
const String AgencyIdKey = "Agency_id";
const String ContentName = "content_title";
const String AgencyName = "AgencyTitle";
const String AgentContent = "AgentDescription";
const String AgencyContent = "AgencyDescription";
const String TargetEmailKey = "target_email";
const String AgentPermalink = "AgentLink";
const String AgencyPermalink = "AgencyLink";
